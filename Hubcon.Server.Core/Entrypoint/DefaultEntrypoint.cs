...
namespace Hubcon.Server.Core.Entrypoint
{
    ...
    public static class DefaultEntrypoint
    {
        ...
        /// </summary>
        public static ValueTask<IHubconResponse> HandleMethodWithResult(IOperationRequest request, HubconTransportAttribute transport, IServiceProvider serviceProvider, IWrapper? wrappedRequest, CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        public static ValueTask<IHubconResponse> HandleMethodVoid(IOperationRequest request, HubconTransportAttribute transport, IServiceProvider serviceProvider, IWrapper? wrappedRequest, CancellationToken cancellationToken = default)
        {
            var requestHandler = serviceProvider.GetRequiredService<IRequestHandler>();
        ...
        /// </summary>
        public static ValueTask<IHubconResponse> HandleMethodStream(IOperationRequest request, HubconTransportAttribute transport, IServiceProvider serviceProvider, IWrapper? wrappedRequest, CancellationToken cancellationToken = default)
        {
            var requestHandler = serviceProvider.GetRequiredService<IRequestHandler>();
        ...
        /// </summary>
        public static ValueTask<IHubconResponse> HandleIngest(IOperationRequest request, HubconTransportAttribute transport, IServiceProvider serviceProvider, Dictionary<Guid, object> sources, IWrapper? wrappedRequest, CancellationToken cancellationToken = default)
        {
            var requestHandler = serviceProvider.GetRequiredService<IRequestHandler>();
