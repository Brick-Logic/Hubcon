...
namespace Hubcon
{
    //public sealed class StreamingSettings1 : HubconSettings 
    //{
    //    public override TokenBucketRateLimiter RateBucket { get; }

    //    public StreamingSettings1(
    ...
    //    public static Func<StreamingSettings1> Factory { get; } = () => new();
    //}

    //[AttributeUsage(AttributeTargets.Method)]
    //public sealed class StreamingSettingsAttribute1 : Attribute
    //{
    //    public Func<StreamingSettings1> Factory { get; }
    ...
    //    /// </param>
    //    public StreamingSettingsAttribute1(
    //        int rateTokensPerPeriod = 1000,
    //        int rateTokenLimit = 1000,
    //        QueueProcessingOrder queueProcessingOrder = QueueProcessingOrder.OldestFirst,
    ...
    //        Factory = () => new StreamingSettings1(
    //            rateTokensPerPeriod,
    //            rateTokenLimit,
    //            1,
    ...
    //    public static Func<StreamingSettingsAttribute1> Default { get; } = () => new();
    //}
}
