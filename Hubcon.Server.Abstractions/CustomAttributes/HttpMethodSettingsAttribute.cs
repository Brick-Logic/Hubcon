...
namespace Hubcon
{
    public sealed class MethodSettings : HubconSettings
    {
        ...
        public static Func<MethodSettingsAttribute> Factory { get; } = () => new();
    }

    [AttributeUsage(AttributeTargets.Method)]
    public sealed class MethodSettingsAttribute : Attribute
    {
        public Func<MethodSettings> Factory { get; }
        ...
        /// </param>
        public MethodSettingsAttribute(
            int rateTokensPerPeriod = 1000,
            int rateTokenLimit = 1000,
            QueueProcessingOrder queueProcessingOrder = QueueProcessingOrder.OldestFirst,
            int millisecondsToReplenish = 1000)
        {
            ...
            Factory = () => new MethodSettings(rateTokensPerPeriod, rateTokenLimit, 1, queueProcessingOrder, replenishmentPeriod);
        }
    }
}
