...
namespace Hubcon.Server.Abstractions.Interfaces
{
    public interface ICoreServerOptions
    {
        ...
        ICoreServerOptions AddTransport<T>() where T : class, ITransportAttribute, new();
        ICoreServerOptions AddTransport<T>(T transportAttribute) where T : class, ITransportAttribute;
    }
    ...
    public interface IInternalServerOptions
    {
        ...
        IReadOnlyDictionary<Type, ITransportAttribute> DefaultTransports { get; }
    }
}