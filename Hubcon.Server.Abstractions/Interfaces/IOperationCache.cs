...
namespace Hubcon
{
    ...
    public interface IOperationCache
    {
        ...
        T Set<T>(object key, T value, Action? postEvictionCallback = null, int expirationMinutes = 15);
        ...
        T? GetOrCreate<T>(object key, Func<T?> factory, Action? postEvictionCallback = null, int expirationMinutes = 15);
    }
}
